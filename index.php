...
<head>
	...
	<title>Owen Spencer | Web Developer</title>
	<link rel="stylesheet" type="text/css" href="styles/reset.css" />
	<link rel="stylesheet" type="text/css" href="styles/global.css" />
	<link href='http://fonts.googleapis.com/css?family=Quicksand:300,400,700|Cookie' rel='stylesheet' type='text/css'>	
...
<body>
	<div class="biggie-smalls"><!-Begin Wrapper!->
		<header>
			<div class="logo">
			<span class="fname">Owen</span><span class="lname">Spencer!</span>
			</div>
			<i class="fa fa-bars fa-2x" id="whopper"></i>
			<nav>
				<ul>
					<li><a href="#meet">Meet Owen!</a></li>
					<li><a href="#portfolio">Past Work</a></li>
					<li><a href="#resume">Resume</a></li>
					<li><a href="#contact">Drop a Line</a></li>
				</ul>
			</nav>
		</header>
		<div class="content-wrapper"><!-Begin Content Wrapper!->
			<section class="content-block" id="meet" name="meet">
			...
			<section class="content-block" id="portfolio" name="portfolio">
				...
				<div id="my-portfolio">
					...
					<article class="project-block" id="il-block">
						...
						<div class="project-blurb">
							<p>I have worked closely with this company for many years now and it has been a pleasure to help them build their online presence. The site was done on a minimal budget but we (I had the help of a talented Portland designer) were able to deliver the client a clean, functional, and inviting site that was molded to the experience they wanted for their users. It was built utilizing Bootstrap functionality as well as HTML5 and CSS3.</p>
						</div>
					</article>
					
					<article class="project-block" id="col-block">
					...
					<article class="project-block" id="res-block">
						...
						<div class="project-blurb">
							<img class="screengrab" src="img/resnick.png"/>
					...
					<article class="project-block" id="res-block">
						<h2>SOREL</h2>
						<div class="project-blurb">
							<img class="screengrab" src="img/sorel.png"/>
					...
					<article class="project-block" id="res-block">
						<h2>Icebreaker</h2>
						<div class="project-blurb">
							<img class="screengrab" src="img/icebreaker.jpg"/>
			...
			<section class="content-block" id="resume" name="resume">
				<h1 class="section-headline">Resume <i class="fa fa-graduation-cap"></i></h1>
				<article>
					<h2>Technical Skills</h2>
					<ul id="skills">
						<li class="ts ts3">HTML5</li>
					    <li class="ts ts1">WordPress</li>
					    <li class="ts ts3">Demandware</li>
					    <li class="ts ts2">LESS</li>
						<li class="ts ts1">XML</li>
						<li class="ts ts2">JavaScript</li>
						<li class="ts ts3">CSS3</li>
						<li class="ts ts2">GIT</li>
						<li class="ts ts1">PHP</li>
						<li class="ts ts1">Agile</li>
						<li class="ts ts2">Adobe Suite</li>
					</ul>
				</article>
				<article id="experience">
					...
					<p>Coordinator of the 2011 'Bike Commute Challenge' which is a statewide program with participation of over 1,200 businesses.</p>
					<h3>Organic City Sounds | 2011</h3>
					<p>Design and development of an audio focused WordPress site. </p>
					<h3>Icebreaker Merino Wool | 2011</h3>
					<p>Design and development of business to business splash page with social media integration.</p>
					<h3>The Suite Barbershop | 2010</h3>
					<p>UX design, site design, and site development.</p>
					<h3>InVisible Light | 2010</h3>
					<p>Responsive website, WordPress based blog customization, and support.</p>
				</article>
				
				<article id="education">
					<h2>Education</h2>
					<h3>The Art Institute of Portland</h3>
